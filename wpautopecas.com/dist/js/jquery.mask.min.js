...
function(t, a, e) {
    ...
    var a = function(a, e, n) {
        var s = {
            ...
            getCaret: function() {
                try {
                    ...
                    if (n && -1 === navigator.appVersion.indexOf("MSIE 10")) {
                        var o = n.createRange();
                        o.moveStart("character", -s.val().length),
                        t = o.text.length
                    } else
                        (r || "0" === r) && (t = r);
                    return t
            ...
            events: function() {
                a.on("keydown.mask", function(t) {
                    ...
                    a.data("mask-previus-caret-pos", s.getCaret()),
            ...
            getRegexMask: function() {
                for (var t, a, n, s, r = [], i = 0; i < e.length; i++)
                    (t = o.translation[e.charAt(i)]) ? (a = t.pattern.toString().replace(/.{1}$|^.{1}/g, ""),
                    n = t.optional,
            ...
            calculateCaretPosition: function(t) {
                ...
                if (t !== e) {
                    ...
                    e = e.length;
                    var o, i = t.length, l = t = 0, c = 0, u = 0;
                    ...
                    n > i ? n = 10 * e : r >= n && r !== i ? s.maskDigitPosMapOld[n] || (r = n,
                    n = n - (u - c) - t,
                    s.maskDigitPosMap[n] && (n = r)) : n > r && (n = n + (c - u) + l)
                }
                return n
            },
            ...
            getMasked: function(t, a) {
                var r, i = [], l = void 0 === a ? s.val() : a + "", c = 0, u = e.length, p = 0, f = l.length, d = 1, v = "push", k = -1, m = 0;
                if (a = [],
                n.reverse) {
                    v = "unshift",
                    d = -1;
                ...
                for (; g(); ) {
                    var M = e.charAt(c)
                      , y = l.charAt(p)
                      , b = o.translation[M];
                    b ? (y.match(b.pattern) ? (i[v](y),
                    b.recursive && (-1 === k ? k = c : c === h && c !== k && (c = k - d),
                    h === k && (c -= d)),
                    c += d) : y === r ? (m--,
                    r = void 0) : b.optional ? (c += d,
                    p -= d) : b.fallback ? (i[v](b.fallback),
                    c += d,
                    p -= d) : s.invalid.push({
                        p: p,
                        v: y,
                ...
                return t = e.charAt(h),
                u !== f + 1 || o.translation[t] || i.push(t),
                i = i.join(""),
                s.mapMaskdigitPositions(i, a, f),
                i
            },
            ...
            callbacks: function(t) {
                ...
                c("onInvalid", 0 < s.invalid.length, [r, t, a, s.invalid, n])
            }
        };
        a = t(a);
        ...
        o.remove = function() {
            var t = s.getCaret();
            return o.options.placeholder && a.removeAttr("placeholder"),
    ...
    var e = function() {
        var e = t(this)
          , s = {}
          , r = e.attr("data-mask");
        if (e.attr("data-mask-reverse") && (s.reverse = !0),
        e.attr("data-mask-clearifnotmatch") && (s.clearIfNotMatch = !0),
        "true" === e.attr("data-mask-selectonfocus") && (s.selectOnFocus = !0),
        n(e, r, s))
    ...
    t.fn.mask = function(e, s) {
        ...
        var l = function() {
            if (n(this, e, s))
                return t(this).data("mask", new a(this,e,s))
        };
        return t(this).each(l),
        r && "" !== r && o && (clearInterval(t.maskWatchers[r]),
